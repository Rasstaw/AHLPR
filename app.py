...
with st.container():
    ...
    col1.markdown(
        """
        <h1 style='text-align: center; color: black; font-size: 40px;'>
    ...
    colb1.image("./imgs/background_img.webp", width=600)
    st.write(" ")
...
with st.container():
    ...
    _, colb1, colb3, _ = st.columns([0.2, 0.7, 0.7, 0.2])
    if colb1.button("Upload an Image", on_click=change_state_image_uploader):
        pass
    elif colb2.button("", on_click={}):
        pass
    elif colb3.button("Upload a Video", on_click=change_state_video_uploader):
        pass
